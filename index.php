	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-shopping-bag color-purple"></em>
							...
							<div class="large"><?php echo $itemTotal; ?></div>
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-life-ring color-pink"></em>
							<div class="large"><?php echo $memberTotal; ?></div>
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-red panel-widget ">
						<div class="row no-padding"><em class="fa fa-xl fa-book color-yellow"></em>
							<div class="large"><?php echo $eventTotal; ?></div>
		...
		<div class="panel panel-container">
			<div class="row">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-user-o color-gray"></em>
							<div class="large">52</div>
